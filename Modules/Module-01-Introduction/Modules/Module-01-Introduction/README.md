...
They convert human-readable instructions into machine-readable instructions.
...
Think of .NET as an engine and C# as the driver.
...
It ensures that all .NET languages use the same data types.
...
It allows different .NET languages to communicate with each other.
